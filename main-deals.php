...
<body>
    <div class="container-fluid menu-bar">
        <div class="container menu">
            ...
            <div class="groub-bar">
                ...
                <!--Menu Bar-->
                <div class="menu-btns">
                    <!-- ✅ SIGN IN - Goes to signup process -->
                    <a href="signupProcess.php" class="btn" style="margin-right: 18px;">SignIn</a>
                    <!-- ✅ LOGIN - Goes to login choice page -->
                    <a href="loginChoice.php" class="btn btn-outline-light">Login</a>
                </div>
            </div>
    ...
    <div class="menu-left">
        <ul class="mt-4">
            <li><a href="main-deals.php">Home</a></li>
            <li><a href="#topdeals">Deals</a></li>
            <li><a href="#stores">Stores</a></li>
            <li><a href="#topdeals">Top Deals</a></li>
        </ul>
    ...
    <div class="popup-overlay" id="popupOverlay">
        <div class="popup-box">
            ...
            <button class="btn btn-success mt-3" onclick="closePopup()">
                Close
            </button>
        </div>
    </div>
    <div class="container mt-5 header-text">
        ...
        <form action="" method="GET" class="search mt-4">
            <button
                ...
                style="background-color: #10c875; color: white; border: none;"></button>
            <input
                type="search"
                name="q"
